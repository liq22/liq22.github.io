...
- 📞 手机：18896782803
- ✉️ 邮箱：liq22@tsinghua.org.cn
- 🌐 个人主页：[liq22.github.io](https://liq22.github.io)
...
### 🌍 耶鲁大学统计与数据科学系 (2025年4月-2025年9月)

- **导师：** Lu Lu 教授
- **研究：** 物理信息神经网络、基础模型

### 🧪 清华大学人工智能产业研究院 (2022年4月-2022年9月)
...
**提出即插即用模块实现统一故障诊断基础模型架构**

- HSE: 用于统一故障诊断的即插即用模块 *(Information Fusion 2025, IF=15.5)*

### Neural-Symbolic Diagnosis

**融合神经网络与符号推理，构建可解释的故障诊断方法**

- 透明信息融合网络 *(Advanced Engineering Informatics 2025, IF=8.5)*
- 深度专家网络 *(Journal of Manufacturing Systems 2024, IF=17.6)*
- 透明算子网络 *(IEEE Transactions on Industrial Informatics 2024, IF=12.3)*

### Cross-Domain Diagnosis

**开发域适应与泛化方法，解决跨工况故障诊断难题**

- 跨域增强诊断 *(Reliability Engineering & System Safety 2023, IF=9.4, 高被引🌟)*
- 对抗域不变泛化 *(IEEE Transactions on Industrial Informatics 2022, IF=12.3, 高被引🌟)*
